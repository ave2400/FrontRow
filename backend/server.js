  ...
  try {
    ...
    switch (action) {
      case 'checkConcepts':
        ...
        return res.json({ detectedConcept });
      ...
      case 'getExplanation':
        ...
        return res.json({ response: explanationResponse.choices[0].message.content });
      ...
      case 'getPracticeQuestion':
        ...
        return res.json({ response: questionResponse.choices[0].message.content });
